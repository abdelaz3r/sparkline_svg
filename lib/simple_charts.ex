defmodule SimpleCharts do
  @moduledoc """
  Documentation for `SimpleCharts`.
  """
  ...
  ## Examples
      ...
      iex> SimpleCharts.line([{1, 1}, {2, 2}, {3, 3}])
      svg_string

      iex> SimpleCharts.line([{1, 1}, {2, 2}, {3, 3}], width: 240, height: 80)
      svg_string

  """
  @spec line(datapoints :: datapoints()) :: {:ok, String.t()} | {:error, atom()}
  def line(datapoints), do: line(datapoints, [])

  @spec line(datapoints :: datapoints(), options()) :: {:ok, String.t()} | {:error, atom()}
  def line([], _options) do
    {:error, :empty_datapoints}
  end

  def line(datapoints, options) do
